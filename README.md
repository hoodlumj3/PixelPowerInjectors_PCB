...
![image of small pcb with details documented](./Small/images/EasyEDA_PCB_Document.png "Logo Title Text 1"){width=800}
	_Features_
...
![image of medium pcb with details documented](./Medium/images/EasyEDA_PCB_Document.png "Logo Title Text 1"){width=800}
	_Features_
	* Strain relief for input and output seed pixel wires
	* Strain relief for input and output power.
	* 5Amp @5v (tested to 10A for 10 mins, gets warm) 
...
![image of prop input output pcb with details documented](./PropInputOutput/images/EasyEDA_PCB_Document.png "Logo Title Text 1"){width=800}
	_Features_
